...
/*
    gold:   existing real array
    result: pre-valid array
*/
...
int main(int argc, char** argv) {
    ...
    // x0, y0, x1, y1 describe the complex coordinates mapping into the image viewport
    // the range of complex number C is [x0+y0*i, x1+y1*i]
    float x0 = -2.167;
    float x1 = 1.167;
    float y0 = -1;
    float y1 = 1;
    ...
    // parse commandline options: getopt() / getopt_long().
    int opt;
